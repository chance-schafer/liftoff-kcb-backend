package org.launchcode.liftoff_kcb_backend.services.impl;
...
import org.launchcode.liftoff_kcb_backend.services.AuthService;
...
public class AuthServiceImpl implements AuthService {
    ...
    public String register(RegisterDto registerDto) {
        ...
        Role adminRole = roleRepository.findByName("ADMIN")
                .orElseThrow(() -> new KCBAPIException(HttpStatus.BAD_REQUEST, "Admin Role not set."));
